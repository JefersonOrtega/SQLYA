...
insert into alumnos (legajo,documento,nombre,domicilio)
 values('A428','23545345','Juan Ramon','Duarte 57');

insert into alumnos (legajo,documento,nombre,domicilio)
 values('A298',null,'Jose Valdez','Espaillat 28');
...
insert into peliculas (codigo,titulo,actor,duracion)
 values(40,'Fast and Furios','Vin Disell',120);
...
select nombre+space(1)+upper(apellido) as nombre, stuff(documento,1,0,'DNI Nº ') as documento, 
